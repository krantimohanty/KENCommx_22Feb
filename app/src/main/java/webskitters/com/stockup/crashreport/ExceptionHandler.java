...
package webskitters.com.stockup.crashreport;
...
public class ExceptionHandler implements Thread.UncaughtExceptionHandler {
	...
	String extStorageDirectory = "/sdcard/Stockup/Stockup.txt";
	...
	public void uncaughtException(Thread thread, Throwable exception) {
        ...
        {
            cacheDir=new File(android.os.Environment.getExternalStorageDirectory(),"Stockup");
        }
        else
        ...
        if(!cacheDir.exists())
		    ...
		    if (cacheDir != null) 
		    {		     
		    	 cacheDir=new File(cacheDir,"Stockup.txt");
